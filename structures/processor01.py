...
class Processor01_NucleotideCounter(object):
    """ Object structure containing logic for DNA Nucleotide Counts Processor. """
    ...
    def render_response(self, frequencies):
        """ Method to render stylized response text to user. """
        return " ".join(["{}".format(value) for key, value in frequencies.items()])